...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <h5 style="text-align: center;color:blue;">PMTCT COHORT ANALYSIS REPORTING TOOL </h5>
                        ...
                        <div class="panel-body" style="width:100%;">
                            <form class="form form-vertical" action="#" method="post" id="weeklydataform">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                       <select    name="cohort" id="cohort" class="form-control" >
                                            <option>Select Month</option>
                                            <option value="3mcohort">3m. Cohort</option>
                                            <option value="6mcohort">6m. Cohort</option>
                                            <option value="12mcohort">12m. Cohort</option>
                                ...
                                <!------INDICATORS----->
                                 ...
                                 <div class='control-group'>
                                    <label><font color='red'><b>*</b></font> <span class='badge'>1</span> #Enrolled into cohort</label>
                                  </div></td>
                                 </tr>                                 
                                  <tr>
                                  <td class='col-xs-4'>
                                 <div class='control-group'>
                                    <label>KP</label>
                                    <div class='controls'>
                                   <input onkeypress=' return numbers(event);' onblur='' type='number' min ='0' max='5237'  name='inpatient_adm' id='inpatient_adm' class='form-control' >
                                    </div></div>
                                  </td>
                                  <td class='col-xs-4'>
                                 <div class='control-group'>
